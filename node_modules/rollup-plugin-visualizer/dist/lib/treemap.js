var drawChart = (function (exports) {
  ...
  const Tooltip = ({ node, visible, root, sizeProperty }) => {
      const { availableSizeProperties, getModuleSize, importedByCache, data } = F(StaticContext);
      const ref = s();
      ...
      const content = d(() => {
          ...
          return (o$1(y$1, { children: [o$1("div", { children: path }, void 0),
                  ...
                  !isModuleTree(node.data) && importedByCache.has(node.data.uid) && (o$1("div", { children: [o$1("div", { children: [o$1("b", { children: "Imported By" }, void 0), ":"] }, void 0),
                          [...new Set((_a = importedByCache.get(node.data.uid)) === null || _a === void 0 ? void 0 : _a.map(({ id }) => id))].map((id) => (o$1("div", { children: id }, id)))] }, void 0)),
                  o$1("br", {}, void 0),
      ...
      for (const { source, target } of data.links) {
          for (const sourceUid of Object.values(data.nodeParts[source])) {
              ...
              for (const targetUid of Object.values(data.nodeParts[target])) {
                  ...
                  (_a = importedByCache.get(targetUid)) === null || _a === void 0 ? void 0 : _a.push(data.nodes[sourceUid]);
                  (_b = importedCache.get(sourceUid)) === null || _b === void 0 ? void 0 : _b.push(data.nodes[targetUid]);
              }
          }
      }
